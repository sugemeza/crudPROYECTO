...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <body bgcolor="#9370DB">
                <center>
                <div class="card-header" ><h1>{{ __('REGISTRAR') }}</h1></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                        <label for="id_tipo_documento" class="col-md-4 col-form-label text-md-right">{{ __('id_tipo_documento:') }}</label>

                            <div class="col-md-6">
                                <input id="id_tipo_documento" type="text" class="form-control @error('id_tipo_documento') is-invalid @enderror" name="id_tipo_documento" value="{{ old('id_tipo_documento') }}" required autocomplete="id_tipo_documento" autofocus>
                        ...
                        <div class="form-group row">
                        <label for="numero_documento" class="col-md-4 col-form-label text-md-right">{{ __('numero_documento:') }}</label>
